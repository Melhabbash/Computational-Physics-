...
% Solving this problem using Adams-Bashforth (two-step)method
...
for t=2:1:N
    ...
    Vx0(t+1)=Vx0(t)+h*(1.5*ax0(t)-0.5*ax0(t-1));
    Vy0(t+1)=Vy0(t)+h*(1.5*ay0(t)-0.5*ay0(t-1));
...
for t=2:1:N
    ...
    Vx(t+1)=Vx(t)+h*(1.5*ax(t)-0.5*ax(t-1));
    Vy(t+1)=Vy(t)+h*(1.5*ay(t)-0.5*ay(t-1));

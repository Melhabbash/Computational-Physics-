...
% Solving this problem using Adams-Moulton(cupic)method
...
Vx0(2)=Vx0(1)+(h/24)*(55*ax0(1));
Vy0(2)=Vy0(1)+(h/24)*(55*ay0(1));
ax0(2)=-0.5*p*Cd0*A*sqrt((Vx0(2)^2+Vy0(2)^2))*Vx0(2)/m;
ay0(2)=-0.5*p*Cd0*A*sqrt((Vx0(2)^2+Vy0(2)^2))*Vy0(2)/m-g;

Vx0(3)=Vx0(2)+(h/24)*(55*ax0(2)-59*ax0(1));
Vy0(3)=Vy0(2)+(h/24)*(55*ay0(2)-59*ay0(1));
ax0(3)=-0.5*p*Cd0*A*sqrt((Vx0(3)^2+Vy0(3)^2))*Vx0(3)/m;
ay0(3)=-0.5*p*Cd0*A*sqrt((Vx0(3)^2+Vy0(3)^2))*Vy0(3)/m-g;

Vx0(4)=Vx0(3)+(h/24)*(55*ax0(3)-59*ax0(2)+37*ax0(1));
Vy0(4)=Vy0(3)+(h/24)*(55*ay0(3)-59*ay0(2)+37*ay0(1));
ax0(4)=-0.5*p*Cd0*A*sqrt((Vx0(4)^2+Vy0(4)^2))*Vx0(4)/m;
ay0(4)=-0.5*p*Cd0*A*sqrt((Vx0(4)^2+Vy0(4)^2))*Vy0(4)/m-g;

Vx0(5)=Vx0(4)+(h/24)*(55*ax0(4)-59*ax0(3)+37*ax0(2)-9*ax0(1));
Vy0(5)=Vy0(4)+(h/24)*(55*ay0(4)-59*ay0(3)+37*ay0(2)-9*ay0(1));
...
Vx(2)=Vx(1)+(h/24)*(55*ax(1));
Vy(2)=Vy(1)+(h/24)*(55*ay(1));
ax(2)=-0.5*p*Cd*A*sqrt((Vx(2)^2+Vy(2)^2))*Vx(2)/m;
ay(2)=-0.5*p*Cd*A*sqrt((Vx(2)^2+Vy(2)^2))*Vy(2)/m-g;

Vx(3)=Vx(2)+(h/24)*(55*ax(2)-59*ax(1));
Vy(3)=Vy(2)+(h/24)*(55*ay(2)-59*ay(1));
ax(3)=-0.5*p*Cd*A*sqrt((Vx(3)^2+Vy(3)^2))*Vx(3)/m;
ay(3)=-0.5*p*Cd*A*sqrt((Vx(3)^2+Vy(3)^2))*Vy(3)/m-g;

Vx(4)=Vx(3)+(h/24)*(55*ax(3)-59*ax(2)+37*ax(1));
Vy(4)=Vy(3)+(h/24)*(55*ay(3)-59*ay(2)+37*ay(1));
ax(4)=-0.5*p*Cd*A*sqrt((Vx(4)^2+Vy(4)^2))*Vx(4)/m;
ay(4)=-0.5*p*Cd*A*sqrt((Vx(4)^2+Vy(4)^2))*Vy(4)/m-g;

Vx(5)=Vx(4)+(h/24)*(55*ax(4)-59*ax(3)+37*ax(2)-9*ax(1));
Vy(5)=Vy(4)+(h/24)*(55*ay(4)-59*ay(3)+37*ay(2)-9*ay(1));
